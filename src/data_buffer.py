...
class DataBuffer:
    ...
    def append(self, frame: DataFrame) -> None:
        ...
        with self._lock:
            ...
            self._data[idx, COL_DIST_A] = frame.disturbance_A
            self._data[idx, COL_DIST_B] = frame.disturbance_B
            ...
            if self._recording:
                ...
                self._csv_buffer.append([
                    ...
                    frame.disturbance_A, frame.disturbance_B,
                ])
